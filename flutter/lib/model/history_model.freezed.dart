...
abstract class $HistoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String colorCode, DateTime created});
}
...
class _$HistoryModelImpl implements _HistoryModel {
  const _$HistoryModelImpl({required this.colorCode, required this.created});
  ...
  @override
  String toString() {
    return 'HistoryModel(colorCode: $colorCode, created: $created)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, colorCode, created);
...
abstract class _HistoryModel implements HistoryModel {
  const factory _HistoryModel(
      ...
      required final DateTime created}) = _$HistoryModelImpl;
