          ...
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius:
                      BorderRadius.all(Radius.circular(20.adaptedWidth)),
                  border:
                      Border.all(color: Colors.white, width: 30.adaptedWidth)),
              child: QrImageView(
          ...
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: 80.adaptedWidth, vertical: 10.adaptedHeight),
              child: TextButton(
                child: Text("Receive Color",
                    style: TextStyle(
                        color: Colors.white,
